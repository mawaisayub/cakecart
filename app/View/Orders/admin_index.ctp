<div class="orders index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('shipto'); ?></th>
			<th><?php echo $this->Paginator->sort('shipprovince'); ?></th>
			<th><?php echo $this->Paginator->sort('created'); ?></th>
			<th><?php echo $this->Paginator->sort('modified'); ?></th>
			<th><?php echo $this->Paginator->sort('shipcountry'); ?></th>
			<th><?php echo $this->Paginator->sort('shippostalcode'); ?></th>
